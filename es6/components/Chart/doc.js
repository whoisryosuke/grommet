...
export default (function (Chart) {
  ...
  DocumentedChart.propTypes = {
    ...
    color: PropTypes.string.description('A color identifier to use for the graphic color.').defaultProp('accent-1'),
    ...
    })]).description('The size of the Chart. Defaults to { width: "medium", height: "small" }.'),
    thickness: PropTypes.oneOf(['xsmall', 'small', 'medium', 'large', 'xlarge']).description('The width of the stroke.').defaultProp('medium'),
    type: PropTypes.oneOf(['bar', 'line', 'area']).description('The visual type of meter. The default is bar'),
