      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(CheckBox, { checked: true, label: 'CheckBox', onChange: function onChange() {} }),
            React.createElement(RadioButton, { checked: true, label: 'RadioButton', onChange: function onChange() {} }),
