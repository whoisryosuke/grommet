...
export default (function (Meter) {
  ...
  DocumentedMeter.propTypes = {
    ...
    size: PropTypes.oneOf(['xsmall', 'small', 'medium', 'large', 'xlarge', 'full']).description('The size of the Meter. Defaults to medium.'),
    thickness: PropTypes.oneOf(['xsmall', 'small', 'medium', 'large', 'xlarge']).description('The size of the Meter. Defaults to medium.'),
