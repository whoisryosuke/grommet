...
var _StyledClock2 = _interopRequireDefault(_StyledClock);
...
var Clock = function (_Component) {
  ...
  Clock.prototype.render = function render() {
    ...
    if (seconds) {
      secondLine = _react2.default.createElement(_StyledClock.StyledSecond, {
        animate: inSync,
        night: night,
        theme: theme,
        x1: halfSize,
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_StyledClock.StyledCircle, {
        night: night,
        theme: theme,
        fill: 'none',
        stroke: '#000000',
      ...
      secondLine,
      _react2.default.createElement(_StyledClock.StyledMinute, {
        animate: inSync,
        night: night,
        theme: theme,
        x1: halfSize,
