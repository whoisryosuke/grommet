...
export var withFocus = function withFocus(WrappedComponent) {
  var FocusableComponent = function (_Component) {
    ...
    function FocusableComponent() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FocusableComponent.__proto__ || Object.getPrototypeOf(FocusableComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        mouseActive: false,
        focus: false
    ...
    _createClass(FocusableComponent, [{
      key: 'setMouseActive',
      value: function setMouseActive() {
        this.setState({ mouseActive: true });
      }
    }, {
      key: 'resetMouseActive',
      value: function resetMouseActive() {
